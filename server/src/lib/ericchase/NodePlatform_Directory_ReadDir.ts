...
type DirentArray = NODE_FS_SYNC.Dirent<string>[];

export async function Async_NodePlatform_Directory_ReadDir(path: string, recursive: boolean): Promise<NodePlatform_Result<DirentArray>> {
