...
export class Class_NodePlatform_Path_Object_Absolute_Class {
  root = '';
  dir = '';
  name = '';
  ext = ''; // includes dot
   ...
   */
  slice(start: 0 = 0, end?: number): Class_NodePlatform_Path_Object_Absolute_Class {
    if (start !== 0) {
      start = 0;
    }
    const segments = this.split();
    ...
    return new Class_NodePlatform_Path_Object_Absolute_Class(this.os).overwrite(...this.split().slice(0, end));
  }
}

export function NodePlatform_Path_Object_Absolute_Class(...pathlike: string[]): Class_NodePlatform_Path_Object_Absolute_Class {
  return new Class_NodePlatform_Path_Object_Absolute_Class(process.platform === 'win32' ? 'win32' : 'posix').overwrite(...pathlike);
}
export function NodePlatform_Path_Object_Absolute_Posix_Class(...pathlike: string[]): Class_NodePlatform_Path_Object_Absolute_Class {
  return new Class_NodePlatform_Path_Object_Absolute_Class('posix').overwrite(...pathlike);
}
export function NodePlatform_Path_Object_Absolute_Win32_Class(...pathlike: string[]): Class_NodePlatform_Path_Object_Absolute_Class {
  return new Class_NodePlatform_Path_Object_Absolute_Class('win32').overwrite(...pathlike);
}
