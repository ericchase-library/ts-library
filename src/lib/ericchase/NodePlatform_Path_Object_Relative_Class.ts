...
export class Class_NodePlatform_Path_Object_Relative_Class {
  dir = '';
  name = '';
  ext = ''; // includes dot
   ...
   */
  slice(start?: number, end?: number): Class_NodePlatform_Path_Object_Relative_Class {
    return new Class_NodePlatform_Path_Object_Relative_Class(this.os).overwrite(...this.split().slice(start, end));
  }
}

export function NodePlatform_Path_Object_Relative_Class(...pathlike: string[]): Class_NodePlatform_Path_Object_Relative_Class {
  return new Class_NodePlatform_Path_Object_Relative_Class(process.platform === 'win32' ? 'win32' : 'posix').overwrite(...pathlike);
}
export function NodePlatform_Path_Object_Relative_Posix_Class(...pathlike: string[]): Class_NodePlatform_Path_Object_Relative_Class {
  return new Class_NodePlatform_Path_Object_Relative_Class('posix').overwrite(...pathlike);
}
export function NodePlatform_Path_Object_Relative_Win32_Class(...pathlike: string[]): Class_NodePlatform_Path_Object_Relative_Class {
  return new Class_NodePlatform_Path_Object_Relative_Class('win32').overwrite(...pathlike);
}
