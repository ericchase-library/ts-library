...
import { Class_NodePlatform_Path_Object_Absolute_Class, NodePlatform_Path_Object_Absolute_Posix_Class } from '../../NodePlatform_Path_Object_Absolute_Class.js';
...
describe(NodePlatform_Path_Object_Absolute_Posix_Class.name, () => {
