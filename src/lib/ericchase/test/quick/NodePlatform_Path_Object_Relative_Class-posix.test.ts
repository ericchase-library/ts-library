...
import { Class_NodePlatform_Path_Object_Relative_Class, NodePlatform_Path_Object_Relative_Posix_Class } from '../../NodePlatform_Path_Object_Relative_Class.js';
...
describe(NodePlatform_Path_Object_Relative_Posix_Class.name, () => {
