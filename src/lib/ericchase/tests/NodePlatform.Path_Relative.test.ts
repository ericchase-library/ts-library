...
import { Class_NodePlatform_Path_Object_Relative_Class, NodePlatform_Path_Object_Relative_Class, NodePlatform_Path_Object_Relative_Posix_Class, NodePlatform_Path_Object_Relative_Win32_Class } from '../NodePlatform_Path_Object_Relative_Class.js';
...
describe('Posix ', () => {
  function PathFactory(...pathlike: string[]): Class_NodePlatform_Path_Object_Relative_Class {
    return NodePlatform_Path_Object_Relative_Posix_Class(...pathlike);
  }
  /**
   * Note
...
describe(' Win32', () => {
  function PathFactory(...pathlike: string[]): Class_NodePlatform_Path_Object_Relative_Class {
    return NodePlatform_Path_Object_Relative_Win32_Class(...pathlike);
  }
  const set_relative_paths = Prep_SplitLines(`
    .
    ./
...
test('Agnostic Class', () => {
  if (process.platform === 'win32') {
    expect(NodePlatform_Path_Object_Relative_Class().os).toEqual('win32');
  } else {
    expect(NodePlatform_Path_Object_Relative_Class().os).toEqual('posix');
  }
});
